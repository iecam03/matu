      ...
      function ShopifyBuyInit() {
        ...
        ShopifyBuy.UI.onReady(client).then(function (ui) {
          ui.createComponent('product', {
            id: '6759203766477',
            node: document.getElementById('product-component-1637727104149'),
    ...
    (function () {
      ...
      function ShopifyBuyInit() {
        ...
        ShopifyBuy.UI.onReady(client).then(function (ui) {
          ui.createComponent('product', {
            id: '6759203766477',
            node: document.getElementById('product-component-1639113373011'),
            moneyFormat: '%24%7B%7Bamount_with_comma_separator%7D%7D',
            options: {
      "product": {
        "styles": {
