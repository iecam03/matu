      ...
      function ShopifyBuyInit() {
        ...
        ShopifyBuy.UI.onReady(client).then(function (ui) {
          ui.createComponent('product', {
            id: '6759191183565',
            node: document.getElementById('product-component-1637724397588'),
  ...
  (function () {
    ...
    function ShopifyBuyInit() {
      ...
      ShopifyBuy.UI.onReady(client).then(function (ui) {
        ui.createComponent('product', {
          id: '6759191183565',
          node: document.getElementById('product-component-1639109187201'),
          moneyFormat: '%24%7B%7Bamount_with_comma_separator%7D%7D',
          options: {
    "product": {
      "styles": {
