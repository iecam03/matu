      ...
      function ShopifyBuyInit() {
        ...
        ShopifyBuy.UI.onReady(client).then(function (ui) {
          ui.createComponent('product', {
            id: '6842035634381',
            node: document.getElementById('product-component-1637733223388'),
...
export let herbInicio = `/*<![CDATA[*/
  (function () {
    ...
    function ShopifyBuyInit() {
      ...
      ShopifyBuy.UI.onReady(client).then(function (ui) {
        ui.createComponent('product', {
          id: '6842035634381',
          node: document.getElementById('product-component-1638990356674'),
          moneyFormat: '%24%7B%7Bamount_with_comma_separator%7D%7D',
          options: {
    "product": {
      "styles": {
  ...
  /*]]>*/`
  // <div id='product-component-1638990356674'></div>
