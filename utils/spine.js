      ...
      function ShopifyBuyInit() {
        ...
        ShopifyBuy.UI.onReady(client).then(function (ui) {
          ui.createComponent('product', {
            id: '6759196131533',
            node: document.getElementById('product-component-1637724703012'),
  ...
  (function () {
    ...
    function ShopifyBuyInit() {
      ...
      ShopifyBuy.UI.onReady(client).then(function (ui) {
        ui.createComponent('product', {
          id: '6759196131533',
          node: document.getElementById('product-component-1639111320201'),
          moneyFormat: '%24%7B%7Bamount_with_comma_separator%7D%7D',
          options: {
    "product": {
      "styles": {
