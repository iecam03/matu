      ...
      function ShopifyBuyInit() {
        ...
        ShopifyBuy.UI.onReady(client).then(function (ui) {
          ui.createComponent('product', {
            id: '6759207370957',
            node: document.getElementById('product-component-1637726095304'),
      ...
      (function () {
        ...
        function ShopifyBuyInit() {
          ...
          ShopifyBuy.UI.onReady(client).then(function (ui) {
            ui.createComponent('product', {
              id: '6759207370957',
              node: document.getElementById('product-component-1639113618284'),
              moneyFormat: '%24%7B%7Bamount_with_comma_separator%7D%7D',
              options: {
        "product": {
          "styles": {
